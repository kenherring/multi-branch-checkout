...
import { command_discardChanges, command_patchToWorktree, command_stageNode } from './commands'
...
export function activate(context: vscode.ExtensionContext) {
	...
	vscode.commands.registerCommand('multi-branch-checkout.unstageNode', (node: WorktreeNode) => {
		return command_stageNode(node, 'unstage').then(() => { return worktreeView.refresh() })
	})
}
